...
export function renderSidebar(currentPage) {
  const pageMap = { dashboard:'/', projects:'/projects', 'project-detail':'/projects', prompts:'/prompts', errors:'/errors', 'repair-plans':'/repair-plans', 'import-export':'/import-export', settings:'/settings' };
